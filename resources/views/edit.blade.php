...
<div class="container content">  
    <form id="create-form" action="/todo/update/{{$todo['id']}}" method="POST">
        ...
        @csrf
        {{-- karena di route nya pake method patch sedangkan attribut method di form cuman bisa post/get. jadi yang post nya ditimpa --}}
        @method('PATCH')
        @if ($errors->any())
      ...
      <fieldset>
          ...
          {{-- attribut value fungsinya untuk memasukan data ke input --}}
          {{-- kenapa data nya harus di simpen di input? karena ini kan fitur edit. kalau fitur edit
            belum tentu semua data column diubah. jadi untuk mengantisipasinya 
            hal itu, tampilin dulu semua data di inputnya baru nantinya pengguna yang menentukan data input mana
            yang mau diubah --}}
      ...
      <fieldset>
          ...
          {{-- karena textarea tidak termasuk tag input, untuk menampilkan valuenya di
