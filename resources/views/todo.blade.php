            ...
            @foreach ($todo as $a)
                <div class="comment d-flex align-items-start justify-content-between">
                    <div class="mr-2">
                        ...
                        {{-- kalau status nya selain 1, baru muncul icon checklist yang bisa di click buat update ke complated--}}
                        @else
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <p class="text-muted">{{ $a['status'] == 1 ? 'Completed' : 'On Proccess' }}
                            <span class="date">
                                @if ($a['status'] == 1) selesai pada : {{ \Carbon\Carbon::parse($a['done_time'])->format('j F, Y') }}
                                @else Target : {{ \Carbon\Carbon::parse($a['done_time'])->format('j F, Y') }}
                                @endif
                                </span>
                        </p>
                    </div>
